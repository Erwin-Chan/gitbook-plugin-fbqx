...
module.exports = {
	...
	blocks: {
        ...
        return (this.generator === 'website')?
					"<div class='FBQbox gitQuestion' data-id='"+checksum(blk.body)+"' data-answer='" + JSON.stringify(ans)+ "'>" + para + "<br><button class='btn btn-default btn-sm FBQsubmit'>Submit</button><br><p class='alert alert-default FBQmessage'>Correct.</p></div>":
